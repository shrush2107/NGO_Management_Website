...
if(isset($signin))
{
	$check=mysqli_query($conn,"select * from ngoo where email_id='$email_id' and password='$pass'");
...
<body>
    ...
    <div class="signin-content">               
        ...
        <div class="signin-form">
            ...
            <h4>Welcome!!! Please, fill the details to sign in to you account</h4>
            <?php
            if(count($_GET)>0){
            ...
            ?>
                <form method="POST">
                    ...
                    <a href="signup3.php" class="btn signup-image-link">Create an account</a>
                </form>
                <br><br><br><br><br>
